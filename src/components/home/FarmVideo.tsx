...
export const FarmVideo: React.FC = () => {
  return (
    <section className="w-full relative aspect-video bg-zinc-950 overflow-hidden leading-[0]">
      <iframe
        src="https://www.youtube.com/embed/kY0R4k4Y13g?autoplay=1&mute=1&loop=1&playlist=kY0R4k4Y13g&controls=0&showinfo=0&rel=0&modestbranding=1&iv_load_policy=3&playsinline=1&enablejsapi=1"
        className="absolute inset-0 w-full h-full pointer-events-none scale-105 opacity-60"
        allow="autoplay; encrypted-media"
        title="Super Food Bharat Makhana Harvesting"
      />
      {/* Visual text overlay */}
