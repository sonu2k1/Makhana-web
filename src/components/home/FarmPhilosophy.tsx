...
export const FarmPhilosophy: React.FC = () => {
  return (
    <section className="w-full py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-[#fdfdfb] border-t border-zinc-100">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 space-y-6 text-left">
          ...
          <div className="space-y-5 text-sm sm:text-base text-zinc-600 leading-relaxed font-sans font-medium">
            <p>
              At Ghasphus, we are passionate about providing you with food that not only nourishes your body but also delights your taste buds. Our products are carefully chosen to ensure that they meet the highest standards of quality, purity, and sustainability.
            </p>
            <p>
